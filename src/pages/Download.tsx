...
const DownloadPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Download Jayee Express App | iOS & Android</title>
        <meta name="description" content="Install the Jayee Express app on your device. Shop and sell on campus with ease." />
      </Helmet>
          ...
          <div className="container px-4">
            ...
            <div className="text-center mb-10 md:mb-16">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4">
                {isInstalled || isStandalone ? "App Installed!" : "Get the Jayee Express App"}
              </h1>
              <p className="text-base md:text-xl text-muted-foreground max-w-2xl mx-auto px-2">
                {isInstalled || isStandalone
                  ? "You're all set! The Jayee Express app is ready to use on your device."
                ...
                <Card className="border-2 border-green-500/50 bg-green-500/5">
                  <CardContent className="p-6 md:p-8 text-center">
                    ...
                    <p className="text-sm md:text-base text-muted-foreground">
                      The Jayee Express app is installed on your device. You can find it on your home screen.
                    </p>
                  </CardContent>
                </Card>
              </div>
                ...
                {isAndroid && (
                  <Card className="border-2 border-green-500/50 hover:border-green-500 transition-colors">
                    <CardContent className="p-6 md:p-8 text-center">
                      ...
                      <h2 className="text-xl md:text-2xl font-bold mb-2">Install Jayee Express</h2>
                      <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
                        Tap the button below to add Jayee Express to your home screen
                      </p>
                      {isInstallable ? (
                        <Button 
                          onClick={handleInstall}
                ...
                {isIOS && (
                  <Card className="border-2 hover:border-primary/50 transition-colors">
                    <CardContent className="p-6 md:p-8 text-center">
                      ...
                      <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
                        Follow these simple steps to install Jayee Express on your iPhone
                      </p>
